<div>
    ...
    <div class="mb-3">
        <label for="name" class="form-label fw-bolder">Nombre de la Categoria <span class="text-danger">*</span></label>
        ...
        @enderror
        <label for="Description" class="form-label fw-bolder">Descripción <span class="text-danger">*</span></label>
