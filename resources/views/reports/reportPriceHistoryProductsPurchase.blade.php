                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        <div class="d-flex flex-column flex-grow-1 mr-2 mb-2">
                                            <label for="product_id"
                                                class="form-label @error('product_id') is-invalid @enderror fw-bolder">Producto</label>
                                            <select id="product_id" name="product_id" class="selectpicker form-control ml-2"
                                                data-live-search="true" aria-placeholder="Seleccione el producto"
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        <div class=" col-md-6 d-flex flex-column flex-grow-1 mr-2 px-1 ">
                                            <label for="fecha_inicio"
                                                class="form-label @error('fecha_inicio') is-invalid @enderror fw-bolder">
                                                Fecha de inicio
                                            </label>
                                        ...
                                        <div class=" col-md-6 d-flex flex-column flex-grow-1 mr-2">
                                            <label for="fecha_cierre"
                                                class="form-label @error('fecha_cierre') is-invalid @enderror fw-bolder">
                                                Fecha de cierre
                                            </label>
                                    ...
                                    <tbody>
                                        @foreach ($sales as $ventas)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ${{ number_format($ventas->total_value, 0, ',', '.') }}
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    {{ number_format($ventas->product_tax, 0, ',', '.') }}%
                                                </td>
                                                <td class="text-center">
                                                    ${{ number_format($ventas->net_total, 0, ',', '.') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
